...
public class InterPari extends HttpServlet {
    ...
    System.out.println(so+"????"+evnt);
     ...
     System.out.println("Enc   >>  "+ encstr1);
          ...
          int rs=st.executeUpdate("Insert into intrapar(stdnm,stdreg,stddept,stdem,stdyr,stdclg,inraer,stdso,stdevnt) VALUES('"+s1+"','"+encstr1+"','"+s3+"','"+encstr+"','"+s4+"','"+s5+"','"+intr+"','"+so+"','"+evnt+"')");
          if(rs>0)
           {   
