 ...
 * @author Prabu
 */
public class PrinReg extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet DepReg</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet DepReg at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try
        {
          ...
          int rs=st.executeUpdate("Insert into deplog(depname,deppass,depphno,depmail,depaddr,depnm,event) VALUES('"+s1+"','"+s2+"','"+s3+"','"+s4+"','"+s5+"','"+s6+"','"+s7+"')");
          if(rs>0)
           {   
