...
<link type="text/css" rel="stylesheet" href="css/style.css" />
    ...
    <center>
        <form name="onchange" id="first" action="PrinAp" method="POST">
		<div class="container">
			<!-- Top Navigation -->
                        <br><br><br>
			<header>
        ...
        <label for="selctfile" ></label>
			...
			<div class="component">
				 ...
				 <table border="3" style="color: #000; box-shadow: #000; background: #fff;height: 150px; width: 1200px;text-align: center" >
                    ...
                    ResultSet rs1=st.executeQuery("SELECT * FROM windecl where pstatus='pending' and hstatus='Approved'");
                    while(rs1.next())
                ...
                <input type="submit" value="Submit" style="background: #000;color: #fff"/>
                                        ...
                                        <br><br><a href="index.jsp" style="background: #c7254e;color: #000;width: 1000px;height: 50px">Exit</a>
    </body>
</html>
